...
test: configure
	cmake --build build --target broadcast_log_parser_test realtime_trajectory_logger_test move_limit_test tcp_limit_test tcp_limit_curve_test fault_injection_test controller_integration_test
